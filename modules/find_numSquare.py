...
def main():
    ...
    parser.add_argument('--model-path', type=str, default=model_config.get("digit_model_path", "DS_NUM.bin"),
                        help='Path to BPU Quantized *.bin Model')
    parser.add_argument('--conf-thres', type=float, default=float(model_config.get("conf_thres", 0.30)), help='confidence threshold')
    parser.add_argument('--iou-thres', type=float, default=float(model_config.get("iou_thres", 0.6)), help='IoU threshold')
